...
public class IfElseBranch extends MasterConditionalBranch {
    ...
    public IfElseBranch(LogicOperation logicOperation, ConditionalBranch previous, ProgrammableElement context) {
        this.type = null;
        this.name = logicOperation.getExpression() + "_IF_ELSE_BRANCH";
